...
![Probability Ques 1](C:\Users\Ishita\Downloads\r probability_4.jpg)

![Probability Ques 2](C:\Users\Ishita\Downloads\r probability_2.jpg)

![Probability Ques 2 cont.](C:\Users\Ishita\Downloads\r probability_3.jpg)
...
To dervie our similar non-green buildings set, we took the following assumptions:
...
```{r}
buildings_green = subset(greenbuildings, greenbuildings$green_rating==1, select = - c(greenbuildings$green_rating))
buildings_non_green = subset(greenbuildings, greenbuildings$green_rating==0 ,select =-c(greenbuildings$green_rating))
```
...
library(LICORS)
library(reshape2)
setwd("C:\\Users\\Ani\\Documents\\R\\RStudio\\class scripts")
